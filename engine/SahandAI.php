...
{
    /** 🔖 نسخه موتور */
    public const ENGINE_VERSION = '3.11.0'; // ۳.۱۱.۰: خطایاب ریشه‌ای (کدهای خط‌تیره‌دار + استخراج ساختاریافته Causes/Troubleshooting + ترجمه فارسی فیلدها + نوار پیشرفت) + عکس واقعی AI مقاله + اعداد فارسی تصاویر
