...
$pageData = fetchFromAPI('brand/' . BRAND_ID . '/page/terms');
$content = $pageData['data']['content'] ?? [];
$pageTitle = $pageData['data']['seo']['title'] ?? ('قوانین و مقررات | ' . BRAND_NAME_FA);
$pageDesc = $pageData['data']['seo']['description'] ?? 'قوانین استفاده از خدمات';
$crumbTitle = 'قوانین و مقررات';
require __DIR__ . '/_page_base.php';
?>
<section class="section">
    <div class="container prose-page">
        <h1 class="page-title">📜 قوانین و مقررات</h1>
