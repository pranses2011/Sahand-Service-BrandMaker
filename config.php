 ...
 * 🌍 تنظیمات عمومی
 * -------------------------------------------------- */
define('SAHAND_VERSION', '2.24.0');             // نسخه سیستم (۲.۲۴.۰ — ریشه‌یابی قطعی استقرار تازه: پوشه‌های پیش‌ساخته مانع استخراج fileop بودند + رفع صفحات خالی سایت برند (require توابع رندر) + پالت زنده تم از API + مرحله مقالات تک‌به‌تک + مقاوم‌سازی خطایاب + افزودن/حذف دستگاه در ویرایش برند + ۴ سرویس عکس رایگان جدید)
