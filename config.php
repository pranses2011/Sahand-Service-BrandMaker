 ...
 * 🌍 تنظیمات عمومی
 * -------------------------------------------------- */
define('SAHAND_VERSION', '2.13.0');             // نسخه سیستم (۲.۱۳.۰ — خطایاب دو-منظوره وب+پایگاه دانش رسمی + پس‌زمینه شفاف لوگوهای JPG در OG + تصاویر مقاله ضدکشیدگی با واترمارک بزرگ‌تر + رفع ذخیره تنظیمات + رفع undefined استقرار + قانون کادر زیبا + قالب‌ساز ۷۴ عنصر با ترکیب گروهی + cron خودکار + ۱۴ فونت آزاد جدید + ۲۳ فونت همگی قابل نصب)
