...
{
    /** 🔖 نسخه موتور */
    public const ENGINE_VERSION = '3.15.0'; // ۳.۱۵.۰: مقاوم‌سازی خطایاب در برابر پایان زمان سرور (shutdown JSON + تشخیص پاسخ HTML در فرانت + پیام اقدام‌پذیر — ریشه «Unexpected token '<'») + AiPhotoService v3.1 با ۱۸ سرویس (۷ رایگان بدون کلید: پولینیشنز×۲ + AI Horde + لورم‌فلیکر + ویکیمدیا + لکسیکا + پیکسام — دو دومی عکس واقعی موضوعی با کلیدواژه دستگاه) + کلیدواژه استوک ۴۲ دستگاه | قبل: ۳.۱۴.۰: خطایاب همه‌جانبه — بودجه ۱۳۰ث + راند نجات همیشه + واریانت کد + KB ال‌جی + AiPhotoService v3
