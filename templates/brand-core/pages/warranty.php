...
$pageData = fetchFromAPI('brand/' . BRAND_ID . '/page/warranty');
$content = $pageData['data']['content'] ?? [];
$pageTitle = $pageData['data']['seo']['title'] ?? ('ضمانت | ' . BRAND_NAME_FA);
$pageDesc = $pageData['data']['seo']['description'] ?? 'متون ضمانت از تنظیمات نمایندگی خوانده می‌شود و قابل سفارشی‌سازی برای هر برند است.';
$crumbTitle = 'ضمانت';
require __DIR__ . '/_page_base.php';
?>
<section class="section">
    <div class="container prose-page">
        <h1 class="page-title">🛡️ ضمانت</h1>
