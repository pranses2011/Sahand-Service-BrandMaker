<?php
/**
 * 🏢 صفحه درباره نمایندگی
 * @package SahandBrandSite
 */
define('BRAND_INIT', true);
require_once __DIR__ . '/../config.php';
$pageData = fetchFromAPI('brand/' . BRAND_ID . '/page/about-agency');
$content = $pageData['data']['content'] ?? [];
$pageTitle = $pageData['data']['seo']['title'] ?? ('درباره نمایندگی | ' . BRAND_NAME_FA);
$pageDesc = $pageData['data']['seo']['description'] ?? 'معرفی نمایندگی — متن یکتای AI';
$crumbTitle = 'درباره نمایندگی';
require __DIR__ . '/_page_base.php';
?>
<section class="section">
    <div class="container prose-page">
        <h1 class="page-title">🏢 درباره نمایندگی</h1>
