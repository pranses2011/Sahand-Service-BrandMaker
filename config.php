 ...
 * 🌍 تنظیمات عمومی
 * -------------------------------------------------- */
define('SAHAND_VERSION', '2.12.0');             // نسخه سیستم (۲.۱۲.۰ — رفع دو باگ مهم خطایاب/پاک‌سازی تکراری‌ها + فاوآیکون برند + OG شفاف کنتراست‌دار + واترمارک بزرگ‌تر + فونت محیط پنل + قالب‌ساز ۷۰+ عنصر با بلوک ترکیبی + منوهای حرفه‌ای + صفحه کلیدهای API + Addon Domain)
