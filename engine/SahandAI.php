...
{
    /** 🔖 نسخه موتور */
    public const ENGINE_VERSION = '3.13.0'; // ۳.۱۳.۰: خطایاب ریشه‌ای — رفع باگ تاریخی httpGet (static closure — fetchPageText و ۵ ارائه‌دهنده از v2.2 مرده بودند!) + پل jina (جستجوی DDG و خواندن صفحات 403/JS از سرورهای jina — برو‌رفتنی از هر هاست) + کدهای سه‌رقمی تلویزیون (137/324/202...) + رفع regex فیلدها (too large) | قبل: ۳.۱۲.۰: خطایاب ۱۱ ارائه‌دهنده (Google/Yandex/Ecosia/Brave/SearXNG جدید) + راند نجات با مترادف‌های دستگاه + کوئری‌های ۱۲گانه + سقف نرخ ۲۴۰ + AiPhotoService چند-سرویسی (۷ سرویس رایگان با زنجیره انتخابی-اول) + نوار پیشرفت تولید تصاویر مقاله + واترمارک OG فقط نمایندگی
