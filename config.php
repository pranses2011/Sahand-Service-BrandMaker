 ...
 * 🌍 تنظیمات عمومی
 * -------------------------------------------------- */
define('SAHAND_VERSION', '2.9.0');              // نسخه سیستم (۲.۹.۰ — ریشه‌یابی کامل فونت فارسی OG + پس‌زمینه پویا + تحویل URL تلگرام + تصاویر مقاله واقعی + خطایاب کامل + قالب‌ساز المنتوری)
