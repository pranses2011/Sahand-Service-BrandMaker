...
$pageData = fetchFromAPI('brand/' . BRAND_ID . '/page/privacy');
$content = $pageData['data']['content'] ?? [];
$pageTitle = $pageData['data']['seo']['title'] ?? ('حریم خصوصی | ' . BRAND_NAME_FA);
$pageDesc = $pageData['data']['seo']['description'] ?? 'سیاست حفظ حریم خصوصی';
$crumbTitle = 'حریم خصوصی';
require __DIR__ . '/_page_base.php';
?>
<section class="section">
    <div class="container prose-page">
        <h1 class="page-title">🔒 حریم خصوصی</h1>
