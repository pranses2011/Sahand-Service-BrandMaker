...
{
    /** 🔖 نسخه موتور */
    public const ENGINE_VERSION = '3.14.0'; // ۳.۱۴.۰: خطایاب همه‌جانبه — بودجه ۱۳۰ث + راند نجات همیشه + سرچر مشترک + تفکیک شکست زیرساخت از شاهد منفی + واریانت کد + کدهای دوهرفی کامل و چشمک LED + دیکشنری/قطعات تلویزیون-مایکروویو + پنجره کد-محور + KB ال‌جی مایکروویو/تلویزیون + AiPhotoService v3 (۱۴ سرویس) + سقف نرخ ۲۴۰ | قبل: ۳.۱۳.۰: رفع httpGet تاریخی + پل jina + کدهای سه‌رقمی TV
