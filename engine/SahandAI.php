...
{
    /** 🔖 نسخه موتور */
    public const ENGINE_VERSION = '3.12.0'; // ۳.۱۲.۰: خطایاب ۱۱ ارائه‌دهنده (Google/Yandex/Ecosia/Brave/SearXNG جدید) + راند نجات با مترادف‌های دستگاه + کوئری‌های ۱۲گانه + سقف نرخ ۲۴۰ + AiPhotoService چند-سرویسی (۷ سرویس رایگان با زنجیره انتخابی-اول) + نوار پیشرفت تولید تصاویر مقاله + واترمارک OG فقط نمایندگی
